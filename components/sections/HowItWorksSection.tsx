  ...
  return (
    <section className="py-32 px-8 md:px-16 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-5 rounded-[2rem] border border-border-subtle/60 bg-bg-secondary/30 p-10 md:p-12">
        ...
        <div className="lg:col-span-7 space-y-6">
          {steps.map((step, i) => (
            <motion.div
              ...
              className="group rounded-[2rem] border border-border-subtle/60 bg-white/0 hover:bg-white/50 transition-all duration-1000 p-10 md:p-12"
            >
              <div className="flex items-start justify-between gap-8">
                <div>
                  ...
                  <h3 className="text-2xl md:text-3xl font-serif text-text-primary mb-4">{step.title}</h3>
                  <p className="text-text-secondary leading-relaxed font-medium text-[15px] max-w-2xl">{step.desc}</p>
                </div>
                <div className="w-10 h-10 rounded-full bg-bg-secondary/80 border border-border-subtle/60 flex items-center justify-center text-[11px] font-semibold tracking-widest text-text-secondary group-hover:text-text-primary transition-colors">
                  {step.index}
                </div>
              </div>
            </motion.div>
