...
export function Footer({}: FooterProps) {
  return (
    <footer className="py-16 md:py-20 px-8 md:px-16 border-t border-border bg-bg-secondary">
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row justify-between gap-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 text-sm">
          <div className="flex flex-col gap-4">
            ...
            <a href="#" className="font-medium hover:text-safira-mid transition-colors opacity-80 hover:opacity-100">
              Membership
            </a>
            <a href="#" className="font-medium hover:text-safira-mid transition-colors opacity-80 hover:opacity-100">
              Estudos de Caso
